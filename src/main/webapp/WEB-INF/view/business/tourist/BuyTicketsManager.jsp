                ...
                <div class="layui-inline">
                    <div class="layui-input-label">
                        <button type="button" class="layui-btn layui-icon layui-icon-ok-circle"
                                lay-filter="doSubmit" lay-submit="" id="doSubmit">&nbsp;购买
                        </button>
                    </div>
                </div>
                <div class="layui-inline">
...
<script type="text/javascript">
    ...
    layui.use(['table', 'layer', 'form', 'jquery', 'upload'], function () {
        ...
        form.on("submit(doSubmit)", function () {
            ...
            // 发送请求保存订单数据
            $.post("${Path}/order/addTouristOrderData", params, function (value) {
                if (value.code == 200) {
                    // 显示数据表格
        ...
        function initOrderFormData(tableData) {
            // 发送请求获取到订单列表数据
            $.post("${Path}/order/loadOrderFormDataByTourist", function (map) {
                // 给订单输入框赋值

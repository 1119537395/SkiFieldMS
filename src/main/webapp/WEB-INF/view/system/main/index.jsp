...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo" style="font-size: 18px">滑雪场管理系统</a>
            ...
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${Path}/static/images/logo.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${loginUserName}</cite></a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <c:if test="${loginUserType == 1}"><p><span class="userName">${loginUserName}</span>，欢迎登陆</p></c:if>
            <c:if test="${loginUserType == 2}"><p><span class="userName">（工作人员）${loginUserName}</span>，欢迎登陆</p></c:if>
            <c:if test="${loginUserType == 3}"><p><span class="userName">（游客）${loginUserName}</span>，欢迎登陆</p></c:if>
        </div>

        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${Path}/system/toDesktopManager"><span>首页</span></a>
                </li>
            </ul>
        </div>
    </div>
